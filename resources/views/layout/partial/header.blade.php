...
<div id="header" class="app-header">
    ...
    <div class="brand">
        ...
        <a href="#" class="brand-logo">
            <img src="{{ asset('assets/img/logo.png') }}" alt="Vrem" height="20" />
        </a>
    </div>
    <!-- END brand -->
    ...
    <div class="menu">
        ...
        <div class="menu-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right mr-lg-3">
                <a class="dropdown-item d-flex align-items-center" href="{{ route('profile.index') }}">Profile <i class="fa fa-user-circle fa-fw ml-auto text-gray-400 f-s-16"></i></a>
